...
print "#             =||*|*||======||+|+||======||*|*||=             #\n";
print "#               ||[##########|[=]|##########]||               #\n";
print "#               |#| Admin Page Finder V.1.3 |#|               #\n";
print "#               |#|  Create By 'X' Quotes   |#|               #\n";
print "#               |#|    Made In Cambodia     |#|               #\n";
print "#            ==||=============|||=============||==            #\n";
print "#          ====||=============|||=============||====          #\n";
print "#        ======||=============|||=============||======        #\n";
print "###############################################################\n";
print "#          Please Enter Your Target Address Below :           #\n";
print "#                    [Ex: www.target.com]                     #\n";
print "###############################################################\n";
print "\n";
print "-> ";
$site=<STDIN>;
...
print "----------------++++++++++----------------\n";
print "\n";
print "-> Okay Now Enter Target Site Language : [Ex: php Or asp]\n";
print "-> ";
$code=<STDIN>;
chomp($code);
